...
, rgba(0,0,0,0.75)
  ...
  <div class="course-landing__hero__text container">
    ...
    <div class="course-landing__hero__cta flex-col justify-center align-center">
      <a href="#" class="pill-button hero-button" id="<?php echo $course_class ?>-open"><?php echo $cta_text ?></a></div>
  </div>
...
<section class="course-landing__content main-content container">
  <div class="courses-headline">
    <?php echo $course_headline ?>
        ...
        </div><!-- course-landing__content -->


</section><!-- course-landing__content -->
